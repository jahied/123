...
def xoshnaw():
  ...
  try:
    httpCaht = requests.get("https://github.com/jahied/EC-170/main/Ac.txt").text
    if id in httpCaht:
      print("\x1b[0;96m╚═➣ YOUR STATUS ID: ACTIVE \x1b[38;5;46m[✔]")
      msg = str(os.geteuid())
      time.sleep(0.3)
      pass
    else:
      print("\x1b[38;5;208m╚═➣ YOUR ID IS NOT ACTIVE \x1b[38;5;196m[✘]")
      print("\x1b[38;5;44PLEASE YOUR COPY ID SEND TO \x1b[38;5;46mAUTHOR !!!")
      os.system('xdg-open https://wa.me/+8801747951169?text=BANG+SAYA+MAU+AKTIFIN+ID+SCRIPT+CRACK+INSTAGRAM+BANG')
      time.sleep(1)
      sys.exit()
  except:
    sys.exit()
...
def ___login___():
    ...
    print(f"{A}╔══════════════════════════════════════════════════╗")
    print(f"{A}║                                                                                        											   {A}║")
    print(f"{A}║ {A} [{H}❖{H}{A}] {J} USE YOUR COOKIE ACCOUNT {M}!!! 								   {A}║")
    print(f"{A}║ {A} [{H}❖{H}{A}] {A} HOW TO TAKE COOKIE {Z}[{H}OPEN{Z}]{A}                       {A}║")
    print(f"{A}║                                                                                       												{A}║")
    print(f"{A}╚══════════════════════════════════════════════════╝")
    ___cookie = input(f"{J}╚═➣{H} COOKIE :{A} ")
    if ___cookie in ['open', 'Open', 'OPEN']:
        print(f"{A}╚═➣{M} You will be directed to the creator of this program !!!");sleep(3);os.system('xdg-open https://wa.me/+8801747951169?text=Bg+Cara+Ambil+Cookies+Ig+Kek+Mana?');___login___()
    elif ___cookie in ['', ' ']:
        ...
        try:
            ...
            os.system('xdg-open https://wa.me/+8801747951169?text=MAKASIH+BANG+SUDAH+AKTIFIN+ID+GUA')
            print(f"{A}╚═➣{A} Welcome :{H} {___roz['full_name']}");___follow___()
        except (AttributeError, KeyError):
            exit(f"{A}╚═➣{M} COOKIE YOU  PLEASE UPDATE EXCESS !!!")
    ...
    try:
        ...
        with requests.Session() as ses:
            ...
            if '"status":"ok"' in str(___follow):
                print(f"{J}╚═➣{H} SUCCESSFUL LOGIN");___menu___()
            else:
...
def ___menu___():
    ...
    print(f"{A}╔════════════════════════════════════════════════════════════════════════════════════════╗")
    print(f"{A}║                                           {A}║                                            {A}║")
    print(f"{A}║ {A}[{J}1{A}]{A} Dump Username From {H}Following          {A}║  {A}[{J}7{A}]{A} Dump User From {H}Query              {A}║")
...
def ___proxy___():
    try:
        ...
        ___roz = requests.get('https://raw.githubusercontent.com/jahied/EC-170/main/Ac.txt').text
        open('Data/proxy.txt', 'w').write(___roz)
    ___crack___()
# Crack
class ___crack___:
